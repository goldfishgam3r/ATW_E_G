...
if(isset ($_POST['alterar'])) {
	$query = "UPDATE user SET nome = '$_POST[regNameInst]', city = '$_POST[regCityInst]', address ='$_POST[regAddressInst]',telemovel = '$_POST[regPhoneInst]', zip ='$_POST[regZipInst]', email = '$_POST[regEmailInst]' WHERE id_utilizador = '$_POST[Identificador]'";
...
<body id="myPage">
		...
		<div class = "cont container marginTop80">
			<form id="registerInst-form" action="" method="post" role="form">			
				...
				<div class="form-group">
						<label for="inputNameInst">Name</label>
